        ...
        getInstructions(model, type) {
            ...
            this.$http({
                ...
                if (res.data.code == 200) {
                    if (type == 'install') {
                        vm.openReport(
                            baseUrl + res.data.result.installInstructionUrl
                        )
                    } else {
                        vm.openReport(
                            baseUrl + res.data.result.operationInstructionUrl
                        )
                    }
                }
            })
